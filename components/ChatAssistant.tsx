...
const ChatAssistant: React.FC = () => {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    { role: 'model', text: "Hi! I'm Julian's AI assistant. Ask me anything about my work or experience.", timestamp: new Date() }
  ]);
  ...
  const handleSend = async () => {
    ...
    // This construction results in parts: { text: string }[]
  ...
  return (
    <div className="fixed bottom-6 right-6 z-[60]">
      {isOpen ? (
        <div className="glass w-[350px] sm:w-[400px] h-[500px] rounded-2xl flex flex-col shadow-2xl overflow-hidden border border-blue-500/30">
          <div className="p-4 bg-blue-600/20 border-b border-white/10 flex justify-between items-center">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-full bg-blue-500 flex items-center justify-center">
                <span className="text-xs">AI</span>
              </div>
              <span className="font-semibold">Julian's Assistant</span>
            </div>
